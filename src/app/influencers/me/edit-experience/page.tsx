...
interface EditExperienceFormData {
  campaignName: string
  brandCompany: string
...
const EditExperiencePage = () => {
  ...
  const { register, handleSubmit, formState: { errors }, watch, setValue } = useForm<EditExperienceFormData>({
    defaultValues: {
      campaignName: '',
      brandCompany: '',
      campaignCategory: '',
  ...
  const { mutateAsync: EditExperience } = useMutationApi({
    endpoint: 'influencer/experiences',
    method: 'POST'
  })

  // Form submission handler
  const onSubmit = async (data: EditExperienceFormData) => {
