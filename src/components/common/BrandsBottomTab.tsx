...
interface BrandsBottomTabProps {
  className?: string;
  activeTab?: string;
}

const BrandsBottomTab: React.FC<BrandsBottomTabProps> = ({ className, activeTab }) => {
...
export default BrandsBottomTab;