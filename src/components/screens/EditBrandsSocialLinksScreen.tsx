...
interface EditBrandsSocialLinksFormData {
  instagram?: string
  youtube?: string
  facebook?: string
  linkedin?: string
...
interface SocialPlatform {
  key: keyof EditBrandsSocialLinksFormData
  name: string
  icon: string
  placeholder: string
  color: string
...
const EditBrandsSocialLinksScreen = () => {
  ...
  const { handleSubmit, register, formState: { errors }, setValue } = useForm<EditBrandsSocialLinksFormData>({
    defaultValues: {
      instagram: "",
      youtube: "",
      facebook: "",
  ...
  const removePlatform = (platform: string) => {
    ...
    setValue(platform as keyof EditBrandsSocialLinksFormData, "")
  }

  const onSubmit = async (data: EditBrandsSocialLinksFormData) => {
    try {
...
export default EditBrandsSocialLinksScreen